...
<input type="text" v-model="search" style="width:500px;margin-left: 50px;" placeholder="输入id搜索">
    <el-button @click="searchStudentByNo(search)" style="width: 4em; height: 2em; margin-right: 10px;">
      <search style="width: 1em; height: 1em; margin-right: 8px;" />搜索
    </el-button>
    ...
    <div class="allinfo">
      <el-table :data="allinfo">
        ...
        <el-table-column prop="depart" label="学院" align="center"></el-table-column>
...
export default defineComponent({
  ...
  methods: {
    getWant() {
      const params = {
        colums: 1,
        classinfo: "2020软件工程2班",
      }
      getwant(params).then(res => {
        console.log(res)
        this.allinfo=res.data.schools
      }).catch(err => {
        console.log(err);
      })
    },
